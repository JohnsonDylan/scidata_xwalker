...
crosswalks = [{'id': 16, 'table': 'compounds', 'field': 'dsstox_compound_id', 'ontterm_id': 323, 'sdsection': 'system', 'sdsubsection': 'compound', 'sdsubsubsection': 'identifier', 'category': None, 'unit': None, 'datatype': 'string'},
              ...
              {'id': 48, 'table': 'models', 'field': 'name', 'ontterm_id': 9999, 'sdsection': 'methodology', 'sdsubsection': 'model', 'sdsubsubsection': '', 'category': None, 'unit': None, 'datatype': 'string'},
              {'id': 49, 'table': 'qsar_predicted_properties', 'field': 'report_filename', 'ontterm_id': 9999, 'sdsection': 'dataset', 'sdsubsection': 'suppdata', 'sdsubsubsection': None, 'category': None, 'unit': None, 'datatype': 'string'}]

onttermslist = [{'id': 323, 'title': 'Identifier', 'definition': 'One or more characters used to identify, name, or characterize the nature, properties, or contents of a thing. [def-source: NCI]', 'code': 'NCIT_C25364', 'url': 'obo:NCIT_C25364', 'nspace_id': 2, 'sdsection': 'metadata', 'sdsubsection': 'identifier'},
                {'id': 80, 'title': 'SMILES string', 'definition': 'SMILES string corresponding to drug structure [database_cross_reference: PMID:14755292]', 'code': 'MI:2039', 'url': 'obo:MI_2039', 'nspace_id': 2, 'sdsection': 'system', 'sdsubsection': 'compound'},
                {'id': 9999, 'title': 'TEST', 'definition': 'TEST', 'code': 'test_9999', 'url': 'test:test_9999', 'nspace_id': 19, 'sdsection': 'system', 'sdsubsection': ''}]

nspaceslist = [{'id': 2, 'name': 'OBO Foundry', 'ns': 'obo', 'path': 'http://purl.obolibrary.org/obo/', 'homepage': 'http://www.ontobee.org'},
               {'id': 19, 'name': 'SciData', 'ns': 'sdo', 'path': 'https://stuchalk.github.io/scidata/ontology/scidata.owl#', 'homepage': 'https://stuchalk.github.io/scidata/'}]
...
"""Define group overrides to modify organization
    ...
    """
group_overrides = {}
group_overrides.update({'(compounds;qsar_predicted_properties;)(\d{1,})(\/exptdata)':'compounds;qsar_predicted_properties;$!@%/data'})
...
nspaces = get_semantics(object_data_json_flat_filtered, onttermslist, nspaceslist)
